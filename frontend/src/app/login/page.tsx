    ...
    <div className="min-h-screen bg-[#F5F0EB] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#2C2420]">Welcome back</h1>
          <p className="text-sm text-[#A19B95] mt-1">Sign in to access your projects</p>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-[#FFFCF9] border border-[#2C2420]/8 shadow-sm">
          ...
          <div className="mt-6 pt-4 border-t border-[#2C2420]/5 text-center">
            <p className="text-xs text-[#A19B95]">
              ...
              <Link href="/register" className="font-medium text-[#8B5A2B] hover:text-[#6B3F1F] transition-colors">
                Create one
              </Link>
            </p>
          </div>
