  ...
  return (
    <div className="flex min-h-screen bg-[#FAFAFA]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="flex items-center justify-between px-8 py-5 border-b border-zinc-200 bg-white/80 backdrop-blur-xl">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-zinc-900">
              <span className="text-amber-600">9 Planets</span>
              <span className="text-zinc-300"> · </span>
              <span className="text-zinc-400">1 Mission</span>
            </h1>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-7xl mx-auto px-8 py-8">
            ...
            <div className="mb-10 p-6 rounded-2xl text-center bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/60">
              ...
              <p className="text-sm italic max-w-lg mx-auto text-zinc-400">
            ...
            {/* Section Title */}
            <div className="mb-6">
              <h2 className="text-lg font-bold tracking-tight text-zinc-900">Self-Sufficient Planets</h2>
              <p className="text-sm mt-0.5 text-zinc-400">
              ...
              {nonAiraPlanets.map((planet) => {
                ...
                return (
                  <Link
                    ...
                    className="group block rounded-2xl p-5 bg-white border border-zinc-200 hover:border-zinc-300 hover:shadow-md transition-all duration-200"
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-zinc-400">{info.capability}</p>
                        </div>
                      </div>
                      <ArrowUpRight className="w-4 h-4 text-zinc-300 group-hover:text-indigo-500 transition-colors" />
                    </div>
                    <p className="text-xs leading-relaxed mb-4 text-zinc-500">{planet.personality}</p>
