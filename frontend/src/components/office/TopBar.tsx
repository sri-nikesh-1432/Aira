...
export function TopBar({ onSubmitProject, isRunning }: TopBarProps) {
  ...
  const handleSubmit = () => {
    if (inputValue.trim() && onSubmitProject) {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-[#0A0E14] border-b border-[#1A2332]">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <div className="hidden sm:block">
          <p className="text-[10px] font-bold text-white leading-none">
            AIRA AI SOFTWARE COMPANY
          </p>
          <p className="text-[7px] text-[#556677] leading-none mt-0.5">
      ...
      <div className="flex-1 max-w-xl mx-auto">
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#111820] border border-[#1A2332] focus-within:border-[#4FC3F740] transition-colors">
          ...
          <input
            ...
            placeholder={projectIdea ? `Current: ${projectIdea}` : 'Describe your project idea...'}
            disabled={isRunning}
      ...
      <div className="flex items-center gap-4 flex-shrink-0">
        ...
        {/* Time + Live */}
        <div className="text-right">
          <p className="text-[9px] text-[#888] font-mono">{timeStr}</p>
